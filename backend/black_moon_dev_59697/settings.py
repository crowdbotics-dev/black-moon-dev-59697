"""
Django settings for black_moon_dev_59697 project.
...
ROOT_URLCONF = 'black_moon_dev_59697.urls'
...
WSGI_APPLICATION = 'black_moon_dev_59697.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_moon_dev_59697 API",
    "DESCRIPTION": "API documentation for black_moon_dev_59697 App",
    "VERSION": "v1",
}
